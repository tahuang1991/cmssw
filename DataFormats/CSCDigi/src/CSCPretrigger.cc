...
/// Constructors
CSCPretrigger::CSCPretrigger(const int valid, const int quality, const int pattern,
...
bool CSCPretrigger::operator > (const CSCPretrigger& rhs) const {
...
/// Debug
void CSCPretrigger::print() const {
  if (isValid()) {
...
std::ostream & operator<<(std::ostream & o, const CSCPretrigger& digi) {
