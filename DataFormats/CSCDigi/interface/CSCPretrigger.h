#ifndef CSCDigi_CSCPretrigger_h
#define CSCDigi_CSCPretrigger_h
...
class CSCPretrigger {
 ...
 public:
  ...
  /// Constructors
  CSCPretrigger(const int valid, const int quality, const int pattern,
  ...
  /// number.
  bool operator >  (const CSCPretrigger&) const;
